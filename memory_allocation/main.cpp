...
int main() {
  ...
  *pint = 8;            // assign a value to the heap int
  ...
  Animal *panimal =
      new Animal[26];  // create an array of 10 Animals on the heap
  ...
  // panimal[5].setName("George"); // set the name of the 6th Animal in the
  // array panimal[5].speak(); // call the speak() method of the 6th Animal in
  // the array
